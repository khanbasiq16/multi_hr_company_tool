          ...
          .map((field) => (
            <div key={field.id} className="space-y-2 pb-4 last:border-none">
              ...
              {field.type === "short_answer" && (
                <p className="text-gray-700">{field.question} : {field.answer || "—"}</p>
              )}
    ...
    <div className="flex-1">
      ...
      >
        ...
        <SelectContent>
          ...
          <SelectItem value="Dancing Script">
            <span style={{ fontFamily: "Dancing Script" }}>Dancing Script</span>
          </SelectItem>
          <SelectItem value="Pacifico">
            <span style={{ fontFamily: "Pacifico" }}>Pacifico</span>
          </SelectItem>
          <SelectItem value="Cedarville Cursive">
            <span style={{ fontFamily: "Cedarville Cursive" }}>Cedarville Cursive</span>
          </SelectItem>
        </SelectContent>
      </Select>
    </div>
