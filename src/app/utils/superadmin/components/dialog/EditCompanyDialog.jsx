...
//         toast.error("Failed to load time zones");
//       } finally {
...
//               {loadingZones ? (
//                 <p className="text-sm text-gray-500 mt-2">Loading time zones...</p>
//               ) : (
//                 <Select
//                   onValueChange={(value) =>
...
//                 >
//                   <SelectTrigger id="companyTimeZone" className="mt-2 w-full">
...
const EditCompanyDialog = ({ company, open, setOpen }) => {
  ...
  // ✅ Fetch time zones (stable API + fallback)
  useEffect(() => {
    const fetchTimeZones = async () => {
      try {
