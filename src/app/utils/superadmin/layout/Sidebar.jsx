...
//     { href: `/admin/company/${basePath}`, label: "General", icon: <Home className="2xl:w-5 w-4 2xl:h-5 h-4" /> },
//     { href: `/admin/company/${basePath}/clients`, label: "Clients", icon: <PersonStanding className="2xl:w-5 w-4 2xl:h-5 h-4" /> },
//     { href: `/admin/company/${basePath}/contracts`, label: "Contracts", icon: <CardSim className="2xl:w-5 w-4 2xl:h-5 h-4" /> },
//     { href: `/admin/company/${basePath}/templates`, label: "Templates", icon: <NotepadTextDashed className="2xl:w-5 w-4 2xl:h-5 h-4" /> },
//   ]
