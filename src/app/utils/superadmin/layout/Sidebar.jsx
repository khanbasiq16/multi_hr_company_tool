...
const Sidebar = () => {
  ...
  const dashboardLinks = [
    ...
    { href: "/admin/companies", label: "Companies", icon: <Building className="2xl:w-5 w-4 2xl:h-5 h-4" /> },
    { href: "/admin/employees", label: "Employees", icon: <Users className="2xl:w-5 w-4 2xl:h-5 h-4" /> },
    { href: "/admin/attendance", label: "Attendance", icon: <Calendar className="2xl:w-5 w-4 2xl:h-5 h-4" /> },
